...
tavily_tool = TavilyToolSpec( api_key="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" )
search_web = tavily_tool.to_tool_list()[0]
search_web.metadata.name = "search_web"
search_web.metadata.description = "search_web" +  search_web.metadata.description[6:]
# print(search_web)
# print(search_web.metadata.name)
# print("xx")
# print(search_web.metadata.description)
# print('xx')
# print(search_web.metadata.fn_schema)
# exit()
