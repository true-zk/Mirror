...
from mirror.workflow import workflow_1
...
def weekly_diary_summary(
    ...
    prompt = (
        "你是一个日记总结助手，你将获取我本周的日记内容，并根据日记内容生成一篇总结。"
        "任务：帮我总结上周的日记。"
    )
    ...
    if summary == "No diary_summary generated." and verbose:
...
def main(mode=1):
    ...
    diary_manager = DiaryManager()  # Singleton instance
